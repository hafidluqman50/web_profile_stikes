...
class DokumenController extends Controller
{
    public function dokumen() {
    	$title = 'Dokumen | Petugas';
    	$page = 'dokumen-peraturan';
    	$data = Dokumen::with('users')->get();
    	return view('Pengurus.Petugas.page.dokumen-peraturan.main',compact('title','page','data'));
    }

    public function tambahDokumen() {
    	$title = 'Form Dokumen | Petugas';
    	$page = 'dokumen-peraturan';
    	return view('Pengurus.Petugas.page.dokumen-peraturan.form-dokumen-peraturan',compact('title','page'));
    }
    ...
    public function editDokumen($id) {
    	...
    	return view('Pengurus.Petugas.page.dokumen-peraturan.form-dokumen-peraturan',compact('title','page','row'));
    }

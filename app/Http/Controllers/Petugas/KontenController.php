...
class KontenController extends Controller
{
    public function berita() {
    	$title = 'Berita | Petugas';
    	$page = 'berita';
    	$class = 'active';
    	$data = Konten::with('users')->where('kategori','berita')->get();
    	return view('Pengurus.Petugas.page.konten.berita.main',compact('title','page','class','data'));
    }

    public function tambahBerita() {
        $title = 'Form Berita | Petugas';
        $page = 'berita';
        $class = 'active';
        return view('Pengurus.Petugas.page.konten.berita.form-berita',compact('title','page','class'));
    }

    public function editBerita($id) {
        $title = 'Form Agenda | Petugas';
        $page  = 'berita';
        $class = 'active';
        $row = Konten::where('id_konten',$id)->where('kategori','berita')->firstOrFail();
        return view('Pengurus.Petugas.page.konten.berita.form-berita',compact('title','page','class','row'));   
    }

    public function pengumuman() {
    	$title = 'Pengumuman | Petugas';
    	$page = 'pengumuman';
    	$class = 'active';
    	$data = Konten::with('users')->where('kategori','pengumuman')->get();
    	return view('Pengurus.Petugas.page.konten.pengumuman.main',compact('title','page','class','data'));
    }

    public function tambahPengumuman() {
        $title = 'Form Pengumuman | Petugas';
        $page = 'pengumuman';
        $class = 'active';
        return view('Pengurus.Petugas.page.konten.pengumuman.form-pengumuman',compact('title','page','class'));
    }
    ...
    public function editPengumuman($id) {
        ...
        return view('Pengurus.Petugas.page.konten.pengumuman.form-pengumuman',compact('title','page','class','row'));   
    }
    ...
    public function kegiatan() {
    	...
    	return view('Pengurus.Petugas.page.konten.kegiatan.main',compact('title','page','class','data'));
    }

    public function tambahKegiatan() {
        $title = 'Form Kegiatan | Petugas';
        $page = 'kegiatan';
        $class = 'active';
        return view('Pengurus.Petugas.page.konten.kegiatan.form-kegiatan',compact('title','page','class'));
    }
    ...
    public function editKegiatan($id) {
        ...
        return view('Pengurus.Petugas.page.konten.kegiatan.form-kegiatan',compact('title','page','class','row'));   
    }

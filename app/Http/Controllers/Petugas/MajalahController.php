...
class MajalahController extends Controller
{
    public function majalah() {
    	$title = 'Majalah | Petugas';
    	$page = 'majalah';
    	$data = Majalah::with('users')->get();
    	return view('Pengurus.Petugas.page.majalah.main',compact('title','page','data'));
    }

    public function tambahMajalah() {
    	$title = 'Form Majalah | Petugas';
    	$page = 'majalah';
    	return view('Pengurus.Petugas.page.majalah.form-majalah',compact('title','page'));
    }
    ...
    public function editMajalah($id) {
    	...
    	return view('Pengurus.Petugas.page.majalah.form-majalah',compact('title','page','row'));
    }

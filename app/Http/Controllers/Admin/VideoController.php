...
class VideoController extends Controller
{
    public function video() {
    	...
    	return view('Pengurus.Admin.page.video.main',compact('title','page','data'));
    }

    public function tambahVideo() {
    	$title = 'Form Video | Admin';
    	$page = 'video';
    	return view('Pengurus.Admin.page.video.form-video',compact('title','page'));
    }
    ...
    public function editVideo($id) {
        ...
        return view('Pengurus.Admin.page.video.form-video',compact('title','page','row'));
    }

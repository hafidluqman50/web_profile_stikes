			...
			<div class="row">
				<div class="col-lg-12">
					<div class="hero-nav-area">
						<h1 class="text-white">Informasi Publik</h1>
			...
			<div class="col-lg-4">
				<div class="sidebars-area">
					<div class="single-sidebar-widget most-popular-widget">
						<h6 class="title">Informasi Publik</h6>
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/tanggal-penting') }}">
									Tanggal Penting
								</a>
							</div>
						</div>{{-- 
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/berita-dan-pengumuman') }}">
						...
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/penelitian') }}">
									Penelitian
								</a>
							</div>
						</div>
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/foto-kegiatan') }}">
									Foto Kegiatan
								</a>
							</div>
						</div>
						...
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/statistik') }}">
									Statistik
								</a>
							</div>
						</div>
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/seminar-dan-pelatihan') }}">
						...
						<div class="single-list flex-row d-flex">
							<div class="details">
								<a href="{{ url('/informasi/alur-pendaftaran') }}">
									Alur Pendaftaran
								</a>
							</div>
						</div>

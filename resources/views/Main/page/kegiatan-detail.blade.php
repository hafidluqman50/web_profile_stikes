				...
				<div class="col-lg-8 post-list">
					...
					<div class="single-post-wrap">
						<div class="feature-img-thumb relative">
							...
							<img class="img-fluid" src="{{asset('frontend-assets/foto_kegiatan/'.$row->foto_konten)}}" alt="">
						</div>
								...
								<div class="post-lists">
									...
									<div class="single-post d-flex flex-row row">
										<div class="col-md-4 thumb" style="padding-right:0">
											<img class="img-fluid" src="{{ asset('frontend-assets/foto_kegiatan/'.$value->foto_konten) }}" alt="">
										</div>

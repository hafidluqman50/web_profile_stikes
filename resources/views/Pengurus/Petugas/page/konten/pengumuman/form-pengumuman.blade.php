    ...
    <section class="content">
      <div class="container-fluid">
        <div class="alert alert-warning">
          <code class="text-light"><b>Untuk Form Pengumuman Upload Foto Menggunakan text editor</b></code>
        </div>
        <div class="card">
          <div class="card-header">
            <h5 class="title">Form Konten Pengumuman</h5>
          </div>
      <form method="POST" action="{{url('/petugas/konten/save')}}" enctype="multipart/form-data">
            <div class="card-body">
              @csrf

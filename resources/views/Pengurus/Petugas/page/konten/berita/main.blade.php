...
@section('content')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Konten Berita</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
      	<div class="card">
      		<div class="card-header">
      			<h5 class="title">Data Konten Berita</h5>
      		</div>
      		<div class="card-body">
            ...
            @endif
            <a href="{{url('/admin/data-berita/tambah')}}">
            ...
            <br>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('/petugas/data-berita/edit',$value->id_konten) }}">
                      <button class="btn btn-warning">
                        Edit
                      </button>
                    </a>
                    <a href="{{ url('/petugas/konten/berita/delete',$value->id_konten) }}">

...
@section('content')
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Form Menu Kerja Sama</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
      	<div class="card">
      		<div class="card-header">
      			<h5 class="title">Form Menu Kerja Sama</h5>
      		</div>
              ...
              <div class="form-group">
                ...
                <select name="halaman" class="form-control" required="required">
                  ...
                  <option value="dalam-negeri">Perguruan Tinggi > Dalam Negeri</option>
                  <option value="luar-negeri">Perguruan Tinggi > Luar Negeri</option>
                  <option value="pemerintah">Pemerintah</option>
                </select>
              </div>
	      		</div>
      			<input type="hidden" name="menu" value="kerja-sama">

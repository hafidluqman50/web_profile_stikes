    ...
    <section class="content">
      <div class="container-fluid">
      	<div class="card">
            ...
            @endif
            <a href="{{ url('/admin/link-pendaftaran/tambah') }}">
            ...
            <br>
                ...
                <tr>
                  ...
                  <td>{{ $value->link }}</td>
                  <td>
                    <a href="{{ url('/admin/link-pendaftaran/edit',$value->id_link_terkait) }}">
                      <button class="btn btn-warning">
                        Edit
                      </button>
                    </a>
                    <a href="{{ url('/admin/link/pendaftaran/delete',$value->id_link_terkait) }}">
